...
class DriverHomePageWidget extends StatefulWidget {
  const DriverHomePageWidget({Key? key}) : super(key: key);

  @override
  _DriverHomePageWidgetState createState() => _DriverHomePageWidgetState();
}
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('DriverTrackingPage');
                            },
                            child: wrapWithModel(
                              model: _model.driverQuickViewModel,
                              updateCallback: () => setState(() {}),
                              child: DriverQuickViewWidget(
